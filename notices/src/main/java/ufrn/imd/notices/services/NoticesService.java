...
public interface NoticesService {
  ...
  @Bulkhead(name = "create-or-update-notice", fallbackMethod = "createFallback", type = Bulkhead.Type.THREADPOOL)
  ...
  @Bulkhead(name = "create-or-update-notice", fallbackMethod = "updateFallback", type = Bulkhead.Type.THREADPOOL)
  ...
  @Bulkhead(name = "create-or-update-notice", fallbackMethod = "deleteFallback", type = Bulkhead.Type.THREADPOOL)
  ...
  @Bulkhead(name = "read-notice", fallbackMethod = "findFallback", type = Bulkhead.Type.THREADPOOL)
